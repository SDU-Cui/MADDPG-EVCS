...
class Agent():
    def __init__(self, **kwargs):
        ...
        self.agents = [DDPG(self.is_train, self.env.state_dim, self.hidden_dim, self.env.action_dim, self.env.e_max,
    ...
    def train(self):
        train_list, punish_list =  rl_utils.train_off_policy_agent(self.env, self.agents, self.num_episodes, self.replay_buffer, 
